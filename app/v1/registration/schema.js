...
const changePhone = Joi.object().keys({
...
const changePhoneVerify = Joi.object().keys({
phone: Joi.string().length(10).pattern(constants.regexForMobile).required(),
userType: Joi.number().required(),
otp: Joi.string().required(),
...
const verifyForgetPhone = Joi.object().keys({
phone: Joi.string().length(10).pattern(constants.regexForMobile).required(),
userType: Joi.number().required(),
otp: Joi.string().required(),
});
...
const forgetPassword = Joi.object().keys({
    ...
    const changePasswordForgetPhone = Joi.object().keys({
        password: Joi.string().trim().min(6).required(),
